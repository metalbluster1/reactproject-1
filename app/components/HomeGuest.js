        ...
        switch (action.type) {
            ...
            case "passwordImmediately":
                ...
                if (draft.password.value.length > 50) {
                    ...
                    draft.password.message = "Password cannnot exceed 50 characters."
                }
                return
                ...
                <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <CSSTransition in={state.username.hasErrors} timeout={330} classNames="liveValidMessage" unmountOnExit>
                        ...
                        <div className="form-group">
                            ...
                            <CSSTransition in={state.email.hasErrors} timeout={330} classNames="liveValidMessage" unmountOnExit>
                        ...
                        <div className="form-group">
                            ...
                            <CSSTransition in={state.password.hasErrors} timeout={330} classNames="liveValidMessage" unmountOnExit>
